...
function engager_comment_form_fields( $fields ) {
    ...
    $fields   =  array(
        'author' => '<div class="col-sm-12 form-group comment-form-author">' . 
                    '<input class="form-control" id="author" name="author" type="text" placeholder="'.__('* Full Name','engager').'" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></div>',
        'email'  => '<div class="col-sm-6 form-group comment-form-email">'.
                    '<input class="form-control" id="email" placeholder="'.__('* Email Address','engager').'" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></div>',
        'url'    => '<div class=" col-sm-6 form-group comment-form-url">' .
                    '<input class="form-control" id="url" placeholder="'.__('Website','engager').'" name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></div>'        
    );
...
function engager_comment_form( $args ) {
    $args['comment_field'] = '<div class="col-sm-12 form-group comment-form-comment">'.'<textarea class="form-control" id="comment" placeholder="'.__('Write your comment..','engager').'" name="comment" cols="45" rows="8" aria-required="true"></textarea>
        </div>';
