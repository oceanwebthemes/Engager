	...
	<div class="container">
		<div class="row">
			<div class="section-title">
				<h1><?php echo esc_attr(get_theme_mod( 'featured_title', '' )); ?></h1>
			</div>
		</div>
        		 ...
        		 ?>				
    						<div class="columns-5 col-md-3 col-sm-6">
    							<div class="single">
    								...
    								<?php endif;?>
    								<p><?php the_excerpt(); ?></p>
    								<a href="<?php the_permalink();?>" title="" class="btn btn-plain"><?php echo esc_attr(get_theme_mod('feature_read_more','Read More'));?> <i class="fa fa-angle-double-right"></i></a>
    							</div>
    						</div>
    					<?php endwhile;?>
    				<?php endif;?>
